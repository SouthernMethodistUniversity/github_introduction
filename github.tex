...
\begin{itemize}
\item
  \mintinline{sh}{my\_function.c}
\item
  \mintinline{sh}{my\_function2.c}
\item
  \mintinline{sh}{my\_function3.c}
\item
  \mintinline{sh}{my\_function4.c}
\item
  \mintinline{sh}{my\_function\_old.c}
\item
  \mintinline{sh}{my\_function\_older.c}
\item
  \mintinline{sh}{my\_function\_even\_older.c}
\end{itemize}
