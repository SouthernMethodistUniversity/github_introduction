...
\item[\mintinline{sh}{git clone}] this is the primary mechanism for retrieving
  ...
  \mintinline{sh}{checkout} commands, the result is a full repository that may
...
names for standard commands; for example \mintinline{sh}{git ci} is an illegal
command, but \mintinline{sh}{git commit} is allowed.
